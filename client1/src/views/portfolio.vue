    ...
    <div>
        <section id="portfolio" class="portfolio">
            <div class="container">
                ...
                <h2>Portafolio</h2>
                <p>A continuacion podras ver una serie de imagenes las cuales fueron tomadas en nuestras instalaciones con el fin de mostrar un poco mas de nuestro trabajo</p>
                </div>
                ...
                <div class="col-lg-4 col-md-6 portfolio-item filter-app">
                    <div class="portfolio-wrap">
                        <img src="../assets/img3.png" class="img-fluid" alt="">
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6 portfolio-item filter-web">
                    <div class="portfolio-wrap">
                    <img src="../assets/img5.png" class="img-fluid" alt="">
                    </div>
                </div>

                <div class="col-lg-4 col-md-6 portfolio-item filter-app">
                    <div class="portfolio-wrap">
                    <img src="../assets/img6.png" class="img-fluid" alt="">
                    </div>
                </div>
